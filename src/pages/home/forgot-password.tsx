...
export const HomeForgotPasswordSection = () => (
  <SeoSectionShell
      ...
      <CardContent className="flex flex-col items-center gap-5 px-6 pt-8 py-8 text-center sm:px-10 sm:pt-12">
        ...
        <div className="space-y-3">
          <h3 className="text-xl font-semibold text-foreground">
            A privacy-first way to open locked PDF files you are allowed to use
          </h3>
          <p className="text-sm leading-7 text-muted-foreground sm:text-base">
            If you want to unlock PDF without password details at hand, the
            honest answer is that the correct password still matters. What this
            page can do is help when you forgot PDF password information by
            checking the file and testing a limited set of patterns in the
